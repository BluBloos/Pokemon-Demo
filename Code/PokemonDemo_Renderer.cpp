	...
	float PosX, float PosY, char Character, int Invert)
{
	...
	DrawBitmapScaled(buffer, Bitmap, PosX, PosX + Bitmap.Width * Bitmap.Scale, PosY - Bitmap.Height * Bitmap.Scale + OffsetY,
...
internal void DrawNPC(game_offscreen_buffer *buffer, hf_entity *Entity, vector2f ScreenPos)
{
