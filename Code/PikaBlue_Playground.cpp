...
internal void PopMessage(void *Data, unsigned int QueueIndex)
{
	...
	if(MessageQueue->Count > 0)
	{
		...
		MessageQueue->Messages[QueueIndex] = {}; //clear the message
...
struct pokemon_master_animation_header
{
...
struct pokemon_animation_header
{
...
internal void HealPokemon2(void *Data, unsigned int Param)
{
	...
	CreateNewMessage(GameState, 640.0f, 460.0f,
		"Your pokemon were restored to full health!", OVERRIDEWAIT);
}
